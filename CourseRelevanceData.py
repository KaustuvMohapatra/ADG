...
X=data.drop('Description of the need',axis=1) #This is the feature matrix and it contains all the independent variables needed for model training, excluding the target variable.
y=data['Description of the need']  #This is the target variable which will be used as dependent variable for the machine learning model.
...
'''
Accuracy of Logistic Regression: 0.013651877133105802
Accuracy of Random Forest: 0.06143344709897611
Accuracy of Support Vector Machine: 0.013651877133105802

It can be infered that the accuracy scores are very low for Logistic Regression and SVM, even for Random Forest, 
suggesting that the models are not effectively capturing the patterns in the data.
Thus other models like K nearest neighbour and Decision tree are recommended
'''
